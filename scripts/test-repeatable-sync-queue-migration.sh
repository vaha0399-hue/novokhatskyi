...
apply_before_q02 "$CLEAN_DB"; apply_q03 "$CLEAN_DB"; apply_hardening "$CLEAN_DB"; apply_q05 "$CLEAN_DB"; apply_q05_policy_lock "$CLEAN_DB"; apply_q05_window_contract "$CLEAN_DB"
